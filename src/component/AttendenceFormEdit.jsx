...
class AttendenceFormEdit extends Component {
  state = {
    roleData: [],
    positionData: [],
    departmentData: [],
  ...
  //  EmailData: this.props.editData["Email"],
   // PasswordData: "",
    ...
    FirstNameData: this.props.editData["basic_pay"],
    MiddleNameData: this.props.editData["wl_allowence"],
    LastNameData: this.props.editData["hra"],
    DOBData: this.props.editData["conveyence"],
    ContactNoData: this.props.editData["esi_employeer_share"],
    EmployeeCodeData: this.props.editData["esi_employee_share"],
    RoleData: this.props.editData["epf_employee_share"],
    positionData: this.props.editData["epf_employeer_pension"],
    departmentData: this.props.editData["epf_employeer_epf"],
...
export default AttendenceFormEdit;
