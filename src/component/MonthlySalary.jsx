...
import SalaryTable from "./MonthlySalaryTable.jsx";
import MonthlySalaryForm from "./MonthlySalaryForm.jsx";
import SalaryFormEdit from "./MonthlySalaryFormEdit.jsx";
class MonthlySalary extends Component {
  ...
  handleAddSalary = () => {
   ...
   // console.log(e);
    ...
    console.log("new data",this.salaryData);
